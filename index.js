...
toggle.addEventListener("click", function () {
  ...
  if (this.classList.toggle("bi-brightness-high")) {
    ...
    document.querySelector("#resume-button-2").style.border =
      "1px solid orangered";
    ...
    document.querySelector(".github-activity-calendar h1").style.color =
      "white";
    document.querySelector(".github-activity-calendar h1").style.transition =
      "2s";
  } else {
    ...
    document.querySelector("#one>.text-3>span").style.transition = "2s";
    document.querySelector("#resume-button-2>a").style.color =
      "RGB(35, 40, 62)";
    document.querySelector("#resume-button-2").style.transition = "2s";
    document.querySelector("#resume-button-2").style.border =
      "1px solid RGB(35, 40, 62)";
...
var typed = new Typed(".typing", {
  strings: ["A Full Stack Web Developer", "A JAVA Backend Developer"],
  typeSpeed: 100,
  backSpeed: 60,
  loop: true,
});
...
document.querySelector("#resume-link-1").addEventListener("click", () => {
  ...
  window.location.assign(
    "https://drive.google.com/file/d/1Rb0N0jNgYBqA-wxkw8QDu7W65-0kkb9U/view?usp=sharing",
    "_blank"
  );
});
